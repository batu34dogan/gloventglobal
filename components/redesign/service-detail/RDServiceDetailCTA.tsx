...
export default function RDServiceDetailCTA({ slug, description }: { slug: string; description: string }) {
  return (
      ...
      <div className="relative mx-auto max-w-[760px] px-6 text-center sm:px-10">
        ...
        <div className="mt-9 flex flex-wrap items-center justify-center gap-3">
          <button
            type="button"
            onClick={() => {
              trackEvent('free_analysis_cta_click', { location: 'redesign_service_detail_final_cta', service: slug });
          ...
          <Link
            href="/iletisim"
            onClick={() => trackEvent('contact_cta_click', { location: 'redesign_service_detail_final_cta', service: slug })}
