...
export default function RDContactFacts() {
  const item = 'border-t border-white/10 py-5 first:border-t-0 first:pt-0 last:pb-0 lg:py-6 lg:first:pt-0 lg:last:pb-0';
  ...
  return (
    <aside aria-labelledby="ct-facts" className="relative overflow-hidden rounded-3xl bg-[#0F1E3C] p-6 sm:p-8 lg:p-10">
      <span aria-hidden="true" className="absolute inset-x-0 top-0 h-1 bg-gradient-to-r from-[#1B5CD6] to-[#C9A876]" />
      <h3 id="ct-facts" className="text-[1.3rem] font-extrabold text-white lg:text-[1.5rem]">Doğrudan Ulaşın</h3>
