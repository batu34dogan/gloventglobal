    ...
    <section aria-labelledby="pr-journey" className="overflow-hidden border-t border-[#E5E5EC] bg-white py-16 sm:py-24">
      <style>{`
        ...
        @media (prefers-reduced-motion: reduce) {
          .rd-pj-node, .rd-pj-card { transition: none !important; }
      ...
      <div className={sectionShell}>
        ...
        <div className="relative mt-14 lg:mt-20">
          ...
          <span aria-hidden="true" className="absolute bottom-6 left-[21px] top-6 w-[1.5px] bg-gradient-to-b from-[#1B5CD6]/50 via-[#1B5CD6]/30 to-[#C9A876]/60 lg:left-1/2 lg:-translate-x-1/2" />
          ...
          {processSteps.map((s, i) => {
            ...
            return (
              ...
              >
                <div className="flex justify-center lg:col-start-2 lg:row-start-1 lg:pt-6">
